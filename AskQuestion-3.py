...
while True:
    if difficulty == "Easy":
        ...
        hardmin, hardmax = hardmin+(rounds * 5), hardmax+(rounds * 5)
        # Set numbers to random a random number
        ...
        if choice == 1:
            ...
            num1 = random.randint(3, rounds * 3) #change the difficulty of the numbers because when testig tey were to hard to solve, mostly ba
